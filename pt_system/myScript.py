...
users = [
    ...
    {"photo": "assets/profile3.webp","userid": "jin@naver.com", "username": "박지성", "password": "password3", "address": "서울특별시 양천구 신정동", "is_expert": True, "qualification": "Certified Expert", "profile": "스포츠마사지사,퍼스널 트레이닝 자격증,보디빌딩, 피트니스, 크로스핏 등의 대회 참가 및 수상."},
    {"photo": "assets/profile4.webp","userid": "son@naver.com", "username": "차범근", "password": "password4", "address": "경상남도 통영시 도천동", "is_expert": False, "qualification": None, "profile": "프로필4"},
    {"photo": "assets/profile5.webp","userid": "jae@naver.com", "username": "이강인", "password": "password5", "address": "경기도 성남시 수정구", "is_expert": False, "qualification": None, "profile": "프로필5"},
    {"photo": "assets/profile6.webp","userid": "lee@naver.com", "username": "이재성", "password": "password6", "address": "제주도 북제주군 추자면", "is_expert": False, "qualification": None, "profile": "프로필6"},
